        ...
        <div class="row">
            <div class="col-lg-5">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        $editid = $_GET['editid'];
                        $editBrandsSqlResult = mysqli_query($db, "SELECT * FROM brands WHERE ID='$editid'");
                        ...
                        <form method="POST" enctype="multipart/form-data" action="core/update.php">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" name="b_name" placeholder="Enter a brand name ..." value="<?php echo $e_brand_name;?>" class="form-control" required />
                            </div>
                        ...
                        <form method="POST" enctype="multipart/form-data" action="core/insert.php">
                            <div class="form-group mb-4">
                                <label>Brand Name</label>
                                <input type="text" name="b_name" placeholder="Enter Brand Name" class="form-control" required />
                            </div>
            ...
            <div class="card-body">
              ...
              <table class="table table-hover">
                ...
                $allBrandsSql = "SELECT * FROM brands";
              ...
              if(isset($_GET['deleteid'])){
                ...
                delete_file('b_logo','brands','ID',$delete_id,'assets/img/products/brand/');

                DEL('brands','ID',$delete_id,'brand.php');
